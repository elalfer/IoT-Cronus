...
LIB_HOME=/Users/ialbrekh/Documents/Polivalka

WOLFSSL_HOME=$LIB_HOME/wolfssl-3.7.0-bin
LIB_ICAL=$LIB_HOME/libcal/libical-bin/lib
INCLUDE_ICAL=$LIB_HOME/libcal/libical-bin/include


LIB_JSON=$LIB_HOME/json-bin/
INCLUDE_JSON=$LIB_HOME/json/

#CXX_FLAGS="-std=c++11 -O2"
CXX_FLAGS="-O2"
LIBS_EDISON=-lmraa
LIBS="-lwolfssl -lical -lical_cxx"
...
g++ $CXX_FLAGS -c ./gpio_stub.cpp -o gpio.o
...
g++ $CXX_FLAGS ./main.cpp ./cal.o ./net.o ./valve.o ./gpio.o -L$WOLFSSL_HOME/lib -I$WOLFSSL_HOME/include -L$LIB_ICAL -I$INCLUDE_ICAL $LIBS \
	-I$INCLUDE_JSON -L$LIB_JSON -ljson \
