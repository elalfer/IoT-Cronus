...
g++ -O2 ./main.cpp ./cal.o ./net.o ./valve.o -L$WOLFSSL_HOME/lib -I$WOLFSSL_HOME/include -lwolfssl -L$LIB_ICAL -I$INCLUDE_ICAL -lical -lical_cxx -headerpad_max_install_names
